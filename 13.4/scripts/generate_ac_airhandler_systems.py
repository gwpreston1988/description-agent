#!/usr/bin/env python3
"""
Generate AC + Air Handler System descriptions for Goodman R-32 systems
"""
...
# System combinations (AC + Air Handler)
systems = [
    ('GLXS3BN1810', 'AMST24BU13'),  # 1.5 ton
    ('GLXS3BN2410', 'AMST24BU13'),  # 2.0 ton
    ('GLXS3BN3010', 'AMST30BU13'),  # 2.5 ton
    ('GLXS3BN3610', 'AMST36BU13'),  # 3.0 ton
    ('GLXS3BN4210', 'AMST42CU13'),  # 3.5 ton
    ('GLXS3BN4810', 'AMST48CU13'),  # 4.0 ton
    ('GLXS3BN6010', 'AMST60DU13'),  # 5.0 ton
]
...
<head>
    ...
    <title>GOODMAN {ac_tonnage} Ton 13.4 SEER2 R-32 Air Conditioning System with Multi-Position Air Handler</title>
    <style>
        * {{
...
<body>
    <div id="product-container">
        <h1>GOODMAN {ac_tonnage} Ton 13.4 SEER2 R-32 Air Conditioning System with Multi-Position Air Handler</h1>

        <div class="intro-section">
            <p>Experience reliable cooling comfort with this Goodman {ac_tonnage}-ton R-32 13.4 SEER2 air conditioning system. This complete matched system combines a high-efficiency air conditioner outdoor unit with a versatile multi-position air handler. Designed for dependable cooling performance, this system delivers energy efficiency, quiet operation, and reliable comfort with environmentally-friendly R-32 refrigerant.</p>
        </div>
            ...
            <div id="airhandler-specs" class="tab-content">
                ...
                <table class="specs-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><strong>Blower Speeds</strong></td>
                            <td>{ah_speeds}</td>
                        </tr>
                        <tr>
...
for ac_model, ah_model in systems:
    ...
    filename = f"Goodman_R32_AC_System_{ac_model}_{ah_model}.html"
    ...
    print(f"Generated: {tonnage} ton - {ac_model} + {ah_model}")
