#!/usr/bin/env python3
"""
Generate AC + Gas Furnace + Upflow Coil System descriptions for Goodman R-32 systems
"""
...
# System combinations (AC + Gas Furnace + Upflow Coil)
systems = [
    ('GLXS3BN1810', 'GR9S800403ANA', 'CAPTA2422A3'),  # 1.5 ton
    ('GLXS3BN2410', 'GR9S800403ANA', 'CAPTA2422A3'),  # 2.0 ton
    ('GLXS3BN3010', 'GR9S800603ANA', 'CAPTA3022A3'),  # 2.5 ton
    ('GLXS3BN3610', 'GR9S800604BNA', 'CAPTA3626B3'),  # 3.0 ton
    ('GLXS3BN4210', 'GR9S800804CNA', 'CAPTA4230C3'),  # 3.5 ton
    ('GLXS3BN4810', 'GR9S800804CNA', 'CAPTA6030C3'),  # 4.0 ton
    ('GLXS3BN6010', 'GR9S801005CNA', 'CAPTA6030C3'),  # 5.0 ton
]
...
<head>
    ...
    <title>GOODMAN {ac_tonnage} Ton 13.4 SEER2 R-32 {furnace_afue}% AFUE AC System (Upflow Coil)</title>
    <style>
        * {{
...
<body>
    <div id="product-container">
        <h1>GOODMAN {ac_tonnage} Ton 13.4 SEER2 R-32 {furnace_afue}% AFUE AC System (Upflow Coil)</h1>

        <div class="intro-section">
            <p>Experience year-round comfort with this complete Goodman {ac_tonnage}-ton air conditioning system with upflow coil. This matched system combines a high-efficiency 13.4 SEER2 air conditioner for efficient cooling, a {furnace_afue}% AFUE single-stage gas furnace for reliable heating, and a precision-engineered upflow evaporator coil with factory-installed TXV. Designed for dependable performance with environmentally-friendly R-32 refrigerant.</p>
        </div>
...
for ac_model, furnace_model, coil_model in systems:
    ...
    filename = f"Goodman_R32_AC_80AFUE_Upflow_System_{ac_model}_{furnace_model}_{coil_model}.html"
