#!/usr/bin/env python3
"""
Generate product descriptions for Goodman 15.2 SEER2 R-410A AC units
"""
...
<head>
    ...
    <title>Goodman {model_number} {tonnage_str} Ton 15.2 SEER2 Air Conditioner</title>
    <style>
        * {{
...
<body>
    <div id="product-container">
        <h1>GOODMAN {tonnage_str} Ton 15.2 SEER2 R-410A Air Conditioner — {model_number}</h1>

        <div class="intro-section">
            <p>The Goodman {model_number} is a high-efficiency {tonnage_str}-ton air conditioner condenser, delivering 15.2 SEER2 cooling performance. Featuring a {compressor} compressor and reliable R-410A refrigerant, this unit provides consistent cooling efficiency and dependable operation for residential comfort applications.</p>
        </div>
...
# Filter for AC condensers only (GLXS5BA series)
ac_models = {k: v for k, v in specs_data.items() if v['equipment_type'] == 'Air Conditioner Condenser' and k.startswith('GLXS5BA')}
...
for model_number, model_data in ac_models.items():
    ...
    filename = f"Goodman_R410A_AC_{model_number}.html"
