#!/usr/bin/env python3
"""
Generate Heat Pump + Gas Furnace (Dual Fuel) + Horizontal Coil System descriptions for Goodman R-410A systems
"""
...
# System combinations (Heat Pump + Gas Furnace (Dual Fuel) + Horizontal Coil)
# Note: Last one in SKUS has typo "CHPT6030D3" but JSON has "CHPTA6030D3"
systems = [
    ('GLZS5BA1810', 'GR9S800403ANA', 'CHPTA2426B3'),  # 1.5 ton
    ('GLZS5BA2410', 'GR9S800403ANA', 'CHPTA2426B3'),  # 2.0 ton
    ('GLZS5BA3010', 'GR9S800603ANA', 'CHPTA3026B3'),  # 2.5 ton
    ('GLZS5BA3610', 'GR9S800604BNA', 'CHPTA3630B3'),  # 3.0 ton
    ('GLZS5BA4210', 'GR9S800804CNA', 'CHPTA4230C3'),  # 3.5 ton
    ('GLZS5BA4810', 'GR9S800804CNA', 'CHPTA4830C3'),  # 4.0 ton
    ('GLZS5BA6010', 'GR9S801005CNA', 'CHPTA6030D3'),  # 5.0 ton
]
...
<head>
    ...
    <title>GOODMAN {ac_tonnage} Ton 15.2 SEER2 R-410A {furnace_afue}% AFUE Dual Fuel System (Horizontal Coil)</title>
    <style>
        * {{
...
<body>
    <div id="product-container">
        <h1>GOODMAN {ac_tonnage} Ton 15.2 SEER2 R-410A {furnace_afue}% AFUE Dual Fuel System (Horizontal Coil)</h1>

        <div class="intro-section">
            <p>Experience year-round comfort with this complete Goodman {ac_tonnage}-ton dual fuel heat pump system with horizontal coil. This matched system combines a high-efficiency 15.2 SEER2 heat pump for efficient cooling, a {furnace_afue}% AFUE single-stage gas furnace for reliable heating, and a precision-engineered horizontal evaporator coil with factory-installed TXV. Designed for dependable performance with environmentally-friendly R-410A refrigerant.</p>
        </div>
...
for ac_model, furnace_model, coil_model in systems:
    ...
    filename = f"Goodman_R410A_DualFuel_80AFUE_Horizontal_System_{ac_model}_{furnace_model}_{coil_model}.html"
