...
# System combinations (HP + Wall-Mount Handler)
systems = [
    ('GLZS5BA1810', 'AWST18SU1305A'),  # 1.5 ton
    ('GLZS5BA2410', 'AWST24SU1305A'),  # 2.0 ton
    ('GLZS5BA3010', 'AWST30LU1308A'),  # 2.5 ton - 8kW
    ('GLZS5BA3010', 'AWST30LU1310A'),  # 2.5 ton - 10kW
    ('GLZS5BA3610', 'AWST36LU1308A'),  # 3.0 ton - 8kW
    ('GLZS5BA3610', 'AWST36LU1310A'),  # 3.0 ton - 10kW
]
...
<head>
    ...
    <title>GOODMAN {tonnage_display} Ton {hp_seer2} SEER2 R-410A Heat Pump System with Wall-Hung Air Handler</title>
    <style>
        * {{
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <h1>GOODMAN {tonnage_display}.0 Ton Up to {hp_seer2} SEER2 R-410A Heat Pump System with Wall-Hung Air Handler</h1>
        
        <div class="intro">
            <p>This complete Goodman heat pump system combines year-round climate control with space-saving convenience. The wall-mounted air handler features integrated electric heat for supplemental heating when needed, making this matched system ideal for applications where traditional ductwork is not available or practical.</p>
        </div>
...
print(f"\nSuccessfully generated {len(systems)} HP + wall-mount system descriptions!")
