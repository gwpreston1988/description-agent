...
systems = [
    ('GLZS5BA1810', 'AWST18SU1305A'),
    ('GLZS5BA2410', 'AWST24SU1305A'),
    ('GLZS5BA3010', 'AWST30LU1308A'),
    ('GLZS5BA3010', 'AWST30LU1310A'),
    ('GLZS5BA3610', 'AWST36LU1308A'),
    ('GLZS5BA3610', 'AWST36LU1310A'),
]
...
<head>
    ...
    <title>GOODMAN {tonnage_display} Ton 15.2 SEER2 R-410A Heat Pump System with Wall-Hung Air Handler</title>
    <style>
        * {{
...
<body>
    <div id="product-container">
        <h1>GOODMAN {tonnage_display} Ton 15.2 SEER2 R-410A Heat Pump System with Wall-Hung Air Handler</h1>

        <div class="intro-section">
            <p>Experience year-round comfort with this complete Goodman {tonnage_display}-ton heat pump system featuring a space-saving wall-hung air handler with integrated electric heat. This matched system combines a high-efficiency 15.2 SEER2 heat pump with a wall-mounted air handler that includes a {ah_heat_kw}kW electric heat kit for supplemental winter heating. Perfect for homes where floor space is limited, this system delivers efficient heating and cooling with R-410A refrigerant while maximizing your usable living space.</p>
        </div>
                ...
                <table class="specs-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{hp_heating_capacity:,} BTU/h</td>
                        </tr>
                        <tr>
...
print(f"\nSuccessfully generated {len(systems)} heat pump + wall-mount system descriptions!")
