#!/usr/bin/env python3
"""
Generate AC + 92% AFUE Gas Furnace + Upflow Coil System descriptions for Goodman R-32 systems
"""
...
systems = [
    ('GLXS3BN1810', 'GR9S920403AN', 'CAPTA2422A3'),  # 1.5 ton
    ('GLXS3BN2410', 'GR9S920403AN', 'CAPTA2422A3'),  # 2.0 ton
    ('GLXS3BN3010', 'GR9S920603BN', 'CAPTA3626B3'),  # 2.5 ton
    ('GLXS3BN3610', 'GR9S920603BN', 'CAPTA3626B3'),  # 3.0 ton
    ('GLXS3BN4210', 'GR9S920804CN', 'CAPTA4230C3'),  # 3.5 ton
    ('GLXS3BN4810', 'GR9S920804CN', 'CAPTA6030C3'),  # 4.0 ton (fixed typo)
    ('GLXS3BN6010', 'GR9S921005CN', 'CAPTA6030C3'),  # 5.0 ton (fixed typo)
]
...
<head>
    ...
    <title>GOODMAN {ac_tonnage} Ton 13.4 SEER2 R-32 {furnace_afue}% AFUE Gas Furnace Air Conditioning System (Upflow Coil)</title>
    <style>
        * {{
...
for ac_model, furnace_model, coil_model in systems:
    ...
    filename = f"Goodman_R32_AC_92AFUE_Upflow_System_{ac_model}_{furnace_model}_{coil_model}.html"
