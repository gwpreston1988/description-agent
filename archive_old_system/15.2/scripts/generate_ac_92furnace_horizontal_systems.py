#!/usr/bin/env python3
"""
Generate AC + 92% AFUE Gas Furnace + Horizontal Coil System descriptions for Goodman R-410A systems
"""
...
# System combinations (AC + 92% Gas Furnace + Horizontal Coil)
# Note: SKUS file has typo - CHPT6030D3 should be CHPTA6030D3
systems = [
    ('GLXS5BA1810', 'GR9S920403AN', 'CHPTA2426B3'),  # 1.5 ton
    ('GLXS5BA2410', 'GR9S920403AN', 'CHPTA2426B3'),  # 2.0 ton
    ('GLXS5BA3010', 'GR9S920603BN', 'CHPTA3026B3'),  # 2.5 ton
    ('GLXS5BA3610', 'GR9S920603BN', 'CHPTA3630B3'),  # 3.0 ton
    ('GLXS5BA4210', 'GR9S920804CN', 'CHPTA4230C3'),  # 3.5 ton
    ('GLXS5BA4810', 'GR9S920804CN', 'CHPTA4830C3'),  # 4.0 ton
    ('GLXS5BA6010', 'GR9S921005CN', 'CHPTA6030D3'),  # 5.0 ton (fixed typo)
]
...
for ac_model, furnace_model, coil_model in systems:
    ...
    filename = f"Goodman_R410A_AC_92AFUE_Horizontal_System_{ac_model}_{furnace_model}_{coil_model}.html"
...
print(f"\n✓ Successfully generated {len(generated_files)} AC + 92% Furnace + Horizontal Coil system descriptions")
