#!/usr/bin/env python3
"""
Generate AC + 92% AFUE Gas Furnace + Upflow Coil System descriptions for Goodman R-410A systems
"""
...
# System combinations (AC + 92% Gas Furnace + Upflow Coil)
# Note: SKUS file has typos - CAPT6030C3 should be CAPTA6030C3
systems = [
    ('GLXS5BA1810', 'GR9S920403AN', 'CAPTA2422A3'),  # 1.5 ton
    ('GLXS5BA2410', 'GR9S920403AN', 'CAPTA2422A3'),  # 2.0 ton
    ('GLXS5BA3010', 'GR9S920603BN', 'CAPTA3626B3'),  # 2.5 ton
    ('GLXS5BA3610', 'GR9S920603BN', 'CAPTA3626B3'),  # 3.0 ton
    ('GLXS5BA4210', 'GR9S920804CN', 'CAPTA4230C3'),  # 3.5 ton
    ('GLXS5BA4810', 'GR9S920804CN', 'CAPTA6030C3'),  # 4.0 ton (fixed typo)
    ('GLXS5BA6010', 'GR9S921005CN', 'CAPTA6030C3'),  # 5.0 ton (fixed typo)
]
        ...
        <div class="cta-section">
            ...
            <div class="compliance-badge">
                ...
                <div class="badge-content">
                    ...
                    <p>This complete R-410A 15.2 SEER2 air conditioning system meets Department of Energy efficiency requirements for residential HVAC installations in all U.S. climate zones</p>
                </div>
            </div>
...
for ac_model, furnace_model, coil_model in systems:
    ...
    filename = f"Goodman_R410A_AC_92AFUE_Upflow_System_{ac_model}_{furnace_model}_{coil_model}.html"
...
print(f"\n✓ Successfully generated {len(generated_files)} AC + 92% Furnace + Upflow Coil system descriptions")
