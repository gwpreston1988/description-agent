#!/usr/bin/env python3
"""
Generate HP + 92% AFUE Gas Furnace + Horizontal Coil System descriptions for Goodman R-410A systems
"""
...
# System combinations (HP + 92% Gas Furnace + Horizontal Coil)
# Note: SKUS file has typo - CHPT6030D3 should be CHPTA6030D3
systems = [
    ('GLZS5BA1810', 'GR9S920403AN', 'CHPTA2426B3'),  # 1.5 ton
    ('GLZS5BA2410', 'GR9S920403AN', 'CHPTA2426B3'),  # 2.0 ton
    ('GLZS5BA3010', 'GR9S920603BN', 'CHPTA3026B3'),  # 2.5 ton
    ('GLZS5BA3610', 'GR9S920603BN', 'CHPTA3630B3'),  # 3.0 ton
    ('GLZS5BA4210', 'GR9S920804CN', 'CHPTA4230C3'),  # 3.5 ton
    ('GLZS5BA4810', 'GR9S920804CN', 'CHPTA4830C3'),  # 4.0 ton
    ('GLZS5BA6010', 'GR9S921005CN', 'CHPTA6030D3'),  # 5.0 ton (fixed typo)
]
...
def generate_horizontal_92_system_description(ac_data, furnace_data, coil_data):
    """Generate complete 92% AFUE horizontal system description HTML"""
...
<head>
    ...
    <title>GOODMAN {ac_tonnage} Ton 15.2 SEER2 R-410A {furnace_afue}% AFUE Gas Furnace Air Conditioning System (Horizontal Coil)</title>
    <style>
        * {{
...
<body>
    <div id="product-container">
        <h1>GOODMAN {ac_tonnage} Ton 15.2 SEER2 R-410A {furnace_afue}% AFUE Gas Furnace Air Conditioning System (Horizontal Coil)</h1>

        <div class="intro-section">
            <p>Experience reliable home comfort with this complete Goodman {ac_tonnage}-ton R-410A HVAC system (Horizontal Coil). This matched system combines a high-efficiency 15.2 SEER2 heat pump, a {furnace_afue}% AFUE single-stage gas furnace with multi-speed ECM blower, and a precision-engineered horizontal "A" evaporator coil with factory-installed TXV. Designed for dependable year-round heating and cooling performance, this system delivers excellent energy efficiency, quiet operation, and proven reliability with environmentally-friendly R-410A refrigerant.</p>
        </div>
...
# Generate 92% horizontal system descriptions
generated_files = []
for ac_model, furnace_model, coil_model in systems:
    ...
    html_content = generate_horizontal_92_system_description(ac_data, furnace_data, coil_data)

    filename = f"Goodman_R410A_DualFuel_92AFUE_Horizontal_System_{ac_model}_{furnace_model}_{coil_model}.html"
...
print(f"\n✓ Successfully generated {len(generated_files)} HP + 92% Furnace + Horizontal Coil system descriptions")
